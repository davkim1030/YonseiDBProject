...
public class CreateTable {
	...
	public CreateTable(Statement stmt) {
		for(int i = 0; i < 7; i++) {
			...
			switch(i){
			case 0:
				query = "CREATE TABLE 스킬(스킬이름 varchar(30) primary key,"
						+ "체력증가 int not null, "
						+ "마력증가 int not null)";
				log = "스킬";
				break;
			case 1:
				query = "CREATE TABLE 종족 (종족명 varchar(30) primary key,"
						+ "공격력보정 int not null, "
						+ "방어력보정 int not null, "
						+ "체력보정 int not null, "
						+ "마력보정 int not null, "
				...
				break;
			case 2:
				query = "CREATE TABLE 용사 (용사ID varchar(30) primary key,"
						+ "PASSWORD varchar(30) not null,"
						+ "이름 varchar(30) not null, "
						+ "나이 int not null, "
						+ "출생지 varchar(30) not null, "
						+ "공격력 int not null, "
						+ "방어력 int not null, "
						+ "체력 int not null, "
						+ "마력 int not null, "
				...
				break;
			case 3:
				query = "CREATE TABLE 아이템(아이템이름 varchar(30) primary key, "
			...
			case 4:
				...
				break;
			case 5:
				query = "CREATE TABLE 마물군단 (마물군단이름 varchar(30) primary key, "
						+ "병력수 int not null, "
						+ "총공격력 int not null, "
						+ "총방어력 int not null, "
						+ "이동력 int not null, "
				...
				break;
			case 6:
				query = "CREATE TABLE 지휘관 (마물장군이름 varchar(30), "
						+ "마물군단이름 varchar(30), "
